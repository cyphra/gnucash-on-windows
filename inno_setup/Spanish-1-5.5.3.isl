...
; Spanish.isl version 1.3 (20170121) <serrador@tecknolabs.com>
...
LdrCannotCreateTemp=Imposible crear fichero temporal. Instalación interrumpida
LdrCannotExecTemp=Imposible ejecutar fichero en la carpeta temporal. Instalación interrumpida

; *** Startup error messages
LastErrorMessage=%1.%n%nError %2: %3
SetupFileMissing=El fichero %1 no se encuentra en la carpeta de instalación. Por favor, solucione el problema u obtenga una copia nueva del programa.
SetupFileCorrupt=Los ficheros de instalación están defectuosos. Por favor, obtenga una copia nueva del programa.
SetupFileCorruptOrWrongVer=Los ficheros de instalación están defectuosos o son incompatibles con esta versión del programa de instalación. Por favor, solucione el problema u obtenga una copia nueva del programa.
...
MissingWOW64APIs=La versión de Windows que está utilizando no cuenta con la funcionalidad requerida por el instalador para realizar una instalación de 64 bit. Para solucionar este problema, por favor, instale el Service Pack %1.
...
SetupAppRunningError=El programa de instalación ha detectado que %1 está ejecutándose.%n%nPor favor, ciérrelo ahora, luego pulse en Aceptar para continuar o en Cancelar para salir.
UninstallAppRunningError=El desinstalador ha detectado que %1 está ejecutándose.%n%nPor favor, ciérrelo ahora, luego pulse en Aceptar para continuar o en Cancelar para salir.

; *** Misc. errors
ErrorCreatingDir=El programa de instalación no pudo crear la carpeta "%1"
ErrorTooManyFilesInDir=Imposible crear un fichero en la carpeta "%1" porque contiene demasiados ficheros
...
AboutSetupNote=
TranslatorNote=Spanish translation maintained by Francisci Serrador (serrador@tecknolabs.com)
...
; *** Common wizard text
ClickNext=pulse Siguiente para continuar o en Cancelar para salir de la instalación.
BeveledLabel=
BrowseDialogTitle=Buscar Carpeta
BrowseDialogLabel=Seleccione una carpeta y pulsar en Aceptar.
NewFolderName=Crear Carpeta
...
PasswordLabel3=Por favor, introduzca la contraseña y pulse Siguiente para continuar. En las contraseñas se sistinguen mayúsculas y minúsculas.
...
InfoBeforeClickLabel=Cuando esté listo para continuar con la instalación, pulse Siguiente.
WizardInfoAfter=Información
InfoAfterLabel=Es importante que lea la siguiente información antes de continuar.
InfoAfterClickLabel=Cuando esté listo para continuar, pulse Siguiente.
...
SelectDirBrowseLabel=Para continuar, pulse Siguiente. Si desea seleccionar una carpeta diferente, pulse Examinar.
...
SelectComponentsLabel2=Seleccione los componentes que desea instalar y desmarque los componentes que no desea instalar. pulse Siguiente cuando esté listo para continuar.
...
SelectTasksLabel2=Seleccione las tareas adicionales que desea que se realicen durante la instalación de [name] y pulse Siguiente.
...
SelectStartMenuFolderBrowseLabel=Para continuar, pulse Siguiente. Si desea seleccionar una carpeta distinta, pulse Examinar.
...
ReadyLabel2a=pulse en Instalar para continuar con el proceso o pulse en Atrás si desea revisar o cambiar alguna configuración.
ReadyLabel2b=pulse en Instalar para continuar con el proceso.
...
ApplicationsFound=Las siguientes aplicaciones están usando ficheros que necesitan ser actualizados por el programa de instalación. Se recomienda que permita al programa de instalación cerrar automáticamente estas aplicaciones.
ApplicationsFound2=Las siguientes aplicaciones están usando ficheros que necesitan ser actualizados por el programa de instalación. Se recomienda que permita al programa de instalación cerrar automáticamente estas aplicaciones. Al completarse la instalación, el programa de instalación intentará reiniciar las aplicaciones.
CloseApplications=&Cerrar automáticamente las aplicaciones
DontCloseApplications=&No cerrar las aplicaciones
ErrorCloseApplications=El programa de instalación no pudo cerrar de forma automática todas las aplicaciones. Se recomienda que, antes de continuar, cierre todas las aplicaciones que utilicen ficheros que necesitan ser actualizados por el programa de instalación.
...
ClickFinish=pulse en Finalizar para salir del programa de instalación.
...
ShowReadmeCheck=Sí, deseo ver el fichero LÉAME
...
SelectDiskLabel2=Por favor, inserte el Disco %1 y pulse en Aceptar.%n%nSi los ficheros pueden ser hallados en una carpeta diferente a la indicada abajo, introduzca la ruta correcta o pulse Examinar.
PathLabel=&Ruta:
FileNotInDir2=El fichero "%1" no se ha podido hallar en "%2". Por favor, inserte el disco correcto o seleccione otra carpeta.
...
EntryAbortRetryIgnore=pulse en Reintentar para intentarlo de nuevo, en Omitir para continuar de todas formas o en Anular para cancelar la instalación.

; *** Installation status messages
StatusClosingApplications=Cerrando aplicaciones...
StatusCreateDirs=Creando carpetas...
StatusExtractFiles=Extrayendo ficheros...
...
StatusRegisterFiles=Registrando ficheros...
...
ErrorExecutingProgram=Imposible ejecutar el fichero:%n%1
...
; *** INI errors
ErrorIniEntry=Error al crear entrada INI en el fichero "%1".

; *** File copying errors
FileAbortRetryIgnore=pulse en Reintentar para intentarlo de nuevo, en Omitir para excluir este fichero (no recomendado) o en Anular para cancelar la instalación.
FileAbortRetryIgnore2=pulse en Reintentar para intentarlo de nuevo, en Omitir para continuar de todas formas (no recomendado) o en Anular para cancelar la instalación.
SourceIsCorrupted=El fichero de origen está defectuoso
SourceDoesntExist=El fichero de origen "%1" no existe
ExistingFileReadOnly=El fichero existente está marcado como sólo-lectura.%n%npulse en Reintentar para quitar el atributo de sólo-lectura e intentarlo de nuevo, en Omitir para excluir este fichero o en Anular para cancelar la instalación.
ErrorReadingExistingDest=Ocurrió un error mientras se intentaba leer el fichero:
FileExists=El fichero ya existe.%n%n¿Desea sobreescribirlo?
ExistingFileNewer=El fichero existente es más reciente que el que está tratando de instalar. Se recomienda que mantenga el fichero existente.%n%n¿Desea mantener el fichero existente?
ErrorChangingAttr=Ocurrió un error al intentar cambiar los atributos del fichero:
ErrorCreatingTemp=Ocurrió un error al intentar crear un fichero en la carpeta de destino:
ErrorReadingSource=Ocurrió un error al intentar leer el fichero de origen:
ErrorCopying=Ocurrió un error al intentar copiar el fichero:
ErrorReplacingExistingFile=Ocurrió un error al intentar reemplazar el fichero existente:
ErrorRestartReplace=Falló reintento de reemplazar:
ErrorRenamingTemp=Ocurrió un error al intentar renombrar un fichero en la carpeta de destino:
...
ErrorOpeningReadme=Ocurrió un error al intentar abrir el fichero LÉAME.
ErrorRestartingComputer=El programa de instalación no pudo reiniciar el equipo. Por favor, hágalo manualmente.

; *** Uninstaller messages
UninstallNotFound=El fichero "%1" no existe. Imposible desinstalar.
UninstallOpenError=El fichero "%1" no pudo abrirse. Imposible desinstalar
UninstallUnsupportedVer=El fichero de registro para desinstalar "%1" está en un formato no reconocido por esta versión del desinstalador. Imposible desinstalar
...
UninstallOnlyOnWin64=Este programa sólo puede ser desinstalado en Windows de 64-bit.
...
UninstallDataCorrupted=El fichero "%1" está defectuoso. No puede desinstalarse

; *** Uninstallation phase messages
ConfirmDeleteSharedFileTitle=¿Eliminar fichero Compartido?
ConfirmDeleteSharedFile2=El sistema indica que el siguiente fichero compartido no es utilizado por ningún otro programa. ¿Desea eliminar este fichero compartido?%n%nSi elimina el fichero y hay programas que lo utilizan, esos programas podrían dejar de funcionar correctamente. Si no está seguro, elija No. Dejar el fichero en su sistema no producirá ningún daño.
SharedFileNameLabel=fichero:
...
AssocFileExtension=&Asociar %1 con la extensión de fichero %2
AssocingFileExtension=Asociando %1 con la extensión de fichero %2...
